...
class jQueryFM_FileManager
{
    ...
    // public jQueryFM_FileProvider_FS $provider;
     ...
     *
     * @param jQueryFM_FileProvider_Base|string $provider_or_path File provider used to navigate and perform the accions on the explorer, or string to path manipulated using jQueryFM_FileProvider_FS
     */
    ...
    public function process_request(bool $output_response = true)
    {
        ...
        try {
            ...
            switch ($accion) {
                ...
                case 'show':
                case 'download':
                    if ($this->provider->download($file, $accion == 'download')) {
                ...
                default:
                    throw new FileManagerException('invalid_accion');
                    break;
            }
