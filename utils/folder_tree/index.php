...
require_once '/src/jQueryFM/FileManager.php';

// Full featured file manager
print_r('<pre>');
print_r(jQueryFM_FileManager(dirname(__FILE__) . '/folder_tree/testdir/'));
print_r('</pre>');
// $manager = new jQueryFM_FileManager(utils_root . '/folder_tree/testdir/');
$manager->ajax_endpoint = '?isolated=true';
$manager->icons_url     = '../assets/img/fileicons';

// Basic file explorer
$basic                = new jQueryFM_FileManager(utils_root . '/folder_tree/testdir/');
