...
<header class="header">
    <div class="row">
        ...
        <div class="col-10 text-center">
            <h1 class="titulo">Tipos empaque</h1>
        </div>
...
<section id="secForm">
    <form action="<?= catalogosUrl ?>?controller=Catalogo&action=saveTipoEmpaque" method="post" class="formulario" id="formularioTipoEmpaque">
        ...
        <div class="row p-1 ">
            <div class="col-3 text-right">
                <label for="peso_sugerido">Peso sugerido:</label>
            </div>
            <div class="col-9">
                <input type="number" name="peso_sugerido" class="inputSmall" id="peso_sugerido" placeholder="Escribe el peso sugerido" />
            </div>
        </div>
        <div class="row p-1">
    ...
    <table class="table table-condensed" id="tablaTipoEmpaque">
        ...
        <tbody>
            ...
            <tr class="tr">
                ...
                <td id="pesosugeridoTabla"><?= $t->peso_sugerido; ?></td>
                <td>
                    <div>
