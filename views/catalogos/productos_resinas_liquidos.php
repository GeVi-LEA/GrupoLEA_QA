...
<header class="header">
    <div class="row">
        ...
        <div class="col-6 text-center">
            <h1 class="titulo">Productos resinas y liquidos</h1>
        </div>
    ...
    <form action="<?= catalogosUrl ?>?controller=Catalogo&action=saveProductoResinaLiquido" method="post" class="formulario" id="formularioProductoResinaLiquido">
        ...
        <div class="row p-1">
            ...
            <div class="col-9 d-flex justify-content-between">
                <input type="text" name="producto" class="inputMedium capitalize" id="producto" maxlength="60" placeholder="Ej.NA-321210" />
            </div>
        </div>
