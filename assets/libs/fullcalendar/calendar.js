function calendario_usuario() {
  ...
  this.INICIAR = function () {
    ...
    var arrayEventos = [
        {
          title: "All Day Event",
          start: new Date(r, o, 1),
          className: "bg-primary",
        },
        {
          title: "Long Event",
          start: new Date(r, o, a - 5),
          end: new Date(r, o, a - 2),
          className: "bg-warning",
        },
        {
          id: 999,
          title: "Repeating Event",
          start: new Date(r, o, a - 3, 16, 0),
          allDay: !1,
          className: "bg-info",
        },
        {
          id: 999,
          title: "Repeating Event",
          start: new Date(r, o, a + 4, 16, 0),
          allDay: !1,
          className: "bg-primary",
        },
        {
          title: "Meeting",
          start: new Date(r, o, a, 10, 30),
          allDay: !1,
          className: "bg-success",
        },
        {
          title: "Lunch",
          start: new Date(r, o, a, 12, 0),
          end: new Date(r, o, a, 14, 0),
          allDay: !1,
          className: "bg-danger",
        },
        {
          title: "Birthday Party",
          start: new Date(r, o, a + 1, 19, 0),
          end: new Date(r, o, a + 1, 22, 30),
          allDay: !1,
          className: "bg-success",
        },
        {
          title: "Click for Google",
          start: new Date(r, o, 28),
          end: new Date(r, o, 29),
          url: "http://google.com/",
          className: "bg-dark",
        },
      ...
      m =
        ...
        document.getElementById("calendario_eventos"));
    function u(e) {
      l.show(),
    ...
    var y = new FullCalendar.Calendar(m, {
      timeZone: "local",
      editable: !0,
      droppable: !0,
      selectable: !0,
      ...
      eventClick: function (e) {
        (document.getElementById("btn-delete-event").style.display = "block"),
          ...
          (document.getElementById("event-category").value = d.classNames[0]),
          (i = null),
