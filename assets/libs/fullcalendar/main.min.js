...
var FullCalendar = (function (e) {
  ...
  function D(e) {
    ((!e.__d && (e.__d = !0) && a.push(e) && !b.__r++) ||
      l !== i.debounceRendering) &&
      ((l = i.debounceRendering) || s)(b);
  }
  function b() {
  ...
  function Fe(e, t, n) {
    var r, o;
    for (r = 0; r < n.length; r += 1) if ((o = ze(e, t, n[r]))) return o;
    return 0;
  }
  function ze(e, t, n) {
  ...
  function Et(e, t) {
    ...
    for (var n in t) if (ft.call(t, n) && e[n] !== t[n]) return !1;
    return !0;
  }
  function St(e, t) {
    var n = [];
    for (var r in e) ft.call(e, r) && (r in t || n.push(r));
    for (var r in t) ft.call(t, r) && e[r] !== t[r] && n.push(r);
    return n;
  }
  function Dt(e, t, n) {
    if ((void 0 === n && (n = {}), e === t)) return !0;
    for (var r in t) if (!(r in e) || !bt(e[r], t[r], n[r])) return !1;
  ...
  function wt(e, t, n) {
    ...
    a)) {
      ...
      if (u.recurringDef) {
        ...
        for (
          var d = 0, p = Rt(u, c, t, r, o.recurringTypes);
          d < p.length;
          d++
        ) {
          var f = p[d],
            h = pt(l, { start: f, end: r.add(f, c) });
          s[h.instanceId] = h;
        }
      }
    }
  ...
  function Lt(e) {
    return (
      je(e.getUTCHours(), 2) +
      ":" +
      je(e.getUTCMinutes(), 2) +
      ":" +
      je(e.getUTCSeconds(), 2)
    );
  }
  function Wt(e, t) {
    void 0 === t && (t = !1);
      ...
      return (
        ...
        (e.prototype.formatRange = function (e, t, n, r) {
          ...
          var c = $t(
              (function (e, t) {
                var n = {};
                for (var r in e) (!(r in jt) || jt[r] <= t) && (n[r] = e[r]);
                return n;
              })(o, s),
              i,
              n
  ...
  function hn(e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = Pn(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  var _n = { id: String, groupId: String, title: String, url: String },
    Tn = { start: fn, end: fn, date: fn, allDay: Boolean },
  ...
  function Hn(e, t) {
    ...
    return (
      e.start && ((n = rt(e.start)), r && r <= n && (r = Ke(n, 1))),
      { start: n, end: r }
    );
  }
  function On(e) {
  ...
  var ir = { start: fn, end: fn, allDay: Boolean };
  function ar(e, t, n) {
    var o = (function (e, t) {
        var n = pn(e, ir),
          o = n.refined,
  ...
  function pr(e, t) {
    ...
    return (
      r(
        ...
        ((n = e),
        (o = t.dateEnv),
        r(r({}, ur(n.range, o, n.allDay)), { allDay: n.allDay }))
      ),
      i
    );
  }
  ...
  function gr(e, t, n, o, i) {
    ...
    return (
      ...
      t.allDay &&
        (u.range = { start: rt(u.range.start), end: rt(u.range.end) }),
      u.range.end < u.range.start &&
        (u.range.end = fr(t.allDay, u.range.start, i)),
      u
    );
  }
  var mr = (function () {
  ...
  var br = (function () {
      ...
      return (
        ...
        (e.prototype.addEvent = function (e, t) {
          ...
          else if ("boolean" == typeof t) t && (o = yt(i.eventSources)[0]);
          else if (null != t) {
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: vn(s) }),
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in Tn)
            ...
            (t = _n[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in _n)
            (t = _n[e](t)),
      ...
      return (
        ...
        (e.prototype.offsetForMarker = function (e) {
          return "local" === this.timeZone
            ...
            ? this.namedTimeZoneImpl.offsetForArray(lt(e))
            : null;
        }),
        (e.prototype.toDate = function (e, t) {
          return "local" === this.timeZone
            ...
            ? new Date(
                e.valueOf() -
                  1e3 * this.namedTimeZoneImpl.offsetForArray(lt(e)) * 60
              )
  ...
  function Ur(e) {
    ...
    return new Pr(
      r(r({ timeZone: on.timeZone, calendarSystem: "gregory" }, e), {
        locale: t,
      })
    );
  }
  ...
  function Jr(e, t) {
    return (
      void 0 === t && (t = "day"), JSON.stringify({ date: Ut(e), type: t })
    );
  }
  var Qr,
    eo = null;
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          ...
          !Dt(this.props, e, this.propEquality) ||
            !Dt(this.state, t, this.stateEquality)
        );
      }),
      ...
      return (
        ...
        (t.prototype.renderInnerContent = function () {
          var e = this.context.pluginHooks.contentTypeHandlers,
            ...
            i = null;
          if (
            (void 0 === o && (o = Go(t.defaultContent, t.hookProps)),
            void 0 !== o)
          ) {
  ...
  function Bo() {
    ...
    return function (r, o) {
      return (
        (t && Et(t, o) && r === e) || ((e = r), (t = o), (n = jo(r, o))), n
      );
    };
  }
  function jo(e, t) {
      ...
      n.content &&
        ...
        (o = function (e) {
          return mo(_o.Consumer, null, function (n) {
            return mo(qo, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
  ...
  var $o = (function () {
    ...
    return (
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? kt(1, t) : e || kt({ days: 1 }))
        );
      }),
  ...
  function Qo(e, t, n, o) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return ri(
          e,
          t.sourceIds ? mt(t.sourceIds) : ii(e, o),
          s,
          t.isRefetch || !1,
          o
        );
  ...
  function yi(e, t) {
    for (
      var n = yt(t.getCurrentData().eventSources), r = [], o = 0, i = e;
      o < i.length;
      o++
    ) {
      ...
      eventSourceDefs: [
        {
          ...
          fetch: function (e, t, n) {
            ...
            lo(
              e.eventSource.meta.bind(null, lr(e.range, r)),
              function (e) {
                t({ rawEvents: e });
              },
              n
      ...
      recurringTypes: [
        {
          ...
          expand: function (e, t, n) {
            var r = Wn(t, { start: e.startRecur, end: e.endRecur });
            return r
              ? (function (e, t, n, r) {
                  var o = e ? mt(e) : null,
                    i = rt(n.start),
    ...
    Ho({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, lr(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
    ...
    function e(e) {
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Dr(s.now, l)),
      ...
      for (
        var v = Jo(o.calendarOptions, d, p),
          g = {
      ...
      Ni(g, p) && this.emitter.trigger("loading", !0),
        (this.state = g),
        this.updateData(),
    ...
    return (
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        var a = dn([on, e.optionDefaults, n, o, e.optionOverrides, i]),
          s = r(
            r(r(r(r(r({}, rn), an), sn), cn), t.listenerRefiners),
            t.optionRefiners
          ),
          l = {},
  ...
  var Xi = {},
    ...
    $i = {},
    Ji = { startTime: kt, duration: kt, create: Boolean, sourceId: String };
  function Qi(e) {
    var t = pn(e, Ji),
      n = t.refined,
      r = t.extra;
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ("title" === c)
              (a = !1),
                i.push(mo("h2", { className: "fc-toolbar-title" }, t.title));
            else {
          ...
          if (i.length > 1) {
            ...
            return mo.apply(void 0, o(["div", { className: m }], i));
          }
          return i[0];
        }),
        t
  ...
  var pa = (function (e) {
    ...
    ha = (function (e) {
      function t(t, n) {
        ...
        return (
          (r.initialNowDate = Dr(n.options.now, n.dateEnv)),
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          ...
          return (
            (i = Math.min(864e5, i)),
            {
              currentState: { nowDate: r, todayRange: va(r) },
              nextState: { nowDate: o, todayRange: va(o) },
              waitMs: i,
            }
          );
        }),
  ...
  var ga = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return mo(ha, { unit: "day" }, function (e, t) {
          return mo(
            "tr",
            null,
            i && i("day"),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: $e(e, 1) }, allDay: !1 }, {}, t], n)
          );
        }),
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          ...
          this.forceDayIfListItem &&
            ...
            (n = { start: n.start, end: Ke(n.start, 1) });
          for (
  ...
  function ba(e, t, n) {
    ...
    for (var o in r) if (!zn(t.validRange, r[o].range)) return !1;
    return wa({ eventDrag: e }, n);
  }
  function Ca(e, t, n) {
    return !!zn(t.validRange, e.range) && wa({ dateSelection: e }, n);
  }
  function wa(e, t) {
      ...
      !(
        ...
        !(function (e, t, n, o) {
          var i = t.getCurrentData(),
            ...
            l = s.defs,
            u = s.instances,
            c = Zn(l, a.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          o && (c = gt(c, o));
          var d =
              ((v = e.eventStore),
          ...
          for (var m in u) {
            ...
            for (var _ = i.eventStore, T = 0, k = S.allows; T < k.length; T++) {
              var x = k[T],
                ...
                I = _.instances[m],
                N = void 0;
              if (((N = P ? new Cr(t, P, I) : new Cr(t, D)), !x(pr(M, t), N)))
                return !1;
            }
          }
          return !0;
        ...
        !(
          ...
          !(function (e, t, n, o) {
            ...
            for (var v = 0, g = c.allows; v < g.length; v++) {
              if (!(0, g[v])(pr(r(r({}, n), l), t), null)) return !1;
            }
            return !0;
          })(e, t, n, o)
        )
  ...
  function Na(e) {
    for (
      var t = 0, n = 0, r = be(e, ".fc-scrollgrid-shrink");
      n < r.length;
      n++
    ) {
      var o = r[n];
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return mo(
          ...
          Boolean(!v && p.length) && mo.apply(void 0, o(["thead", {}], p)),
          Boolean(!v && f.length) && mo.apply(void 0, o(["tbody", {}], f)),
          Boolean(!v && h.length) && mo.apply(void 0, o(["tfoot", {}], h)),
          v && mo.apply(void 0, o(o(o(["tbody", {}], p), f), h))
        );
      }),
      (t.prototype.renderSection = function (e, t) {
        return "outerContent" in e
          ? mo(So, { key: e.key }, e.outerContent)
          : mo(
              "tr",
              { key: e.key, className: za(e, this.props.liquid).join(" ") },
  ...
  function Xa(e) {
    return mo(
      ...
      e.timeText && mo("div", { className: "fc-event-time" }, e.timeText),
      mo(
        "div",
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this.props,
          ...
          i = r.isDisabled ? {} : { "data-date": Ut(e.date) };
        return mo(
          zo,
          {
            hookProps: r,
  ...
  function rs(e) {
    return (
      e.event.title && mo("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var os = function (e) {
    return mo(_o.Consumer, null, function (t) {
      ...
      return (
          ...
          return bo(
            mo(
              ...
              mo(
                ...
                mo("span", { className: "fc-popover-title" }, t.title),
                mo("span", {
        ...
        (t.prototype.updateSize = function () {
          var e = this.context.isRtl,
            ...
            i = (function (e) {
              for (
                var t = so(e), n = e.getBoundingClientRect(), r = 0, o = t;
                r < o.length;
                r++
              ) {
  ...
  function cs(e) {
    if (e.allDayDate) return { start: e.allDayDate, end: Ke(e.allDayDate, 1) };
    var t,
      n = e.hiddenSegs;
    return { start: ds(n), end: ((t = n), t.reduce(fs).eventRange.range.end) };
  }
  function ds(e) {
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    mo(
                      ...
                      mo(ia, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
    ...
    ys = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (gs += 1) &&
            window.addEventListener("touchmove", Es, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (gs -= 1) ||
              window.removeEventListener("touchmove", Es, { passive: !1 });
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(ws()));
          }
        }),
        ...
        for (var i in n) {
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              v &&
                zn(v.dateProfile.activeRange, v.dateSpan.range) &&
                (!o || v.layer > o.layer) &&
                ((v.componentId = i),
                (v.context = a.context),
                (v.rect.left += l),
  ...
  function xs(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && sr(e.dateSpan, t.dateSpan))
    );
  }
  function Ms(e, t) {
    for (
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  var f = t.duration
                      ...
                      : fr(e.allDay, p, n),
                    h = pt(d.defId, { start: p, end: f });
                  return { def: d, instance: h };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = vn(s)),
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : on.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : on.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            mo(qo, { viewSpec: r.viewSpec }, function (e, t) {
              return mo(
                "div",
          ...
          return (
            ...
            l &&
              u.push({
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "main", content: Ba }],
              }),
            mo(qo, { viewSpec: a.viewSpec }, function (e, t) {
              return mo(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                mo(o, {
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context.options.navLinks
            ? { "data-navlink": Jr(e.date), tabIndex: 0 }
            : {};
        return mo(
          Ja,
          {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            s = t.dateProfile,
            l = i.navLinks
              ? { "data-navlink": Jr(a, "week"), tabIndex: 0 }
              : {};
          return mo(
            es,
            {
            ...
            function (e, n, i, u) {
              return mo(
                ...
                mo(
                  ...
                  mo("div", { className: "fc-daygrid-day-bg" }, t.bgContent)
                )
              );
            }
          );
  ...
  function il(e, t, n, o) {
    ...
    var i = e.eventRange,
      a = i.range,
      s = Wn(a, { start: o[t].date, end: Ke(o[n - 1].date, 1) });
    return r(r({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
          ...
          if (this.hiddenConsumes && s >= 0)
            for (var l = t.lateralStart; l < t.lateralEnd; l += 1) {
              ...
              if (this.allowReslicing) {
                var c = r(r({}, u), { span: Bi(u.span, n.span) });
                a[(d = Vi(c))] ||
                  ((a[d] = !0), (i[s][l] = c), this.splitEntry(u, n, o));
              } else {
                var d;
                  ...
                  mo(
                    "div",
                    {
                      className:
                        ...
                        (D ? " fc-daygrid-event-harness-abs" : ""),
                      key: E,
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                mo(
                  ...
                  "bg-event" === t ? mo(ns, r({ seg: c }, nr(c, i))) : ts(t)
                )
              );
            }
          ...
          if (!t.forPrint && null !== t.clientWidth) {
            if (e) {
              ...
              if (r.length) {
                ...
                this.setState({ framePositions: new co(o, r, !0, !1) });
              }
            }
  ...
  function ml(e) {
    ...
    return mo(_o.Consumer, null, function (n) {
      if (!e.isLabeled)
        return mo("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return mo("tr", { key: e.key }, mo(ml, r({}, e)));
          });
        }),
        t
      );
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              s =
                o.navLinks && 1 === a
                  ? { "data-navlink": Jr(i.start, "week"), tabIndex: 0 }
                  : {};
            return o.weekNumbers && "day" === e
              ? mo(
                  os,
                  { date: i.start, defaultFormat: Sl },
                  function (e, t, o, i) {
                    return mo(
                      "th",
                      {
                  ...
                  content: function (e) {
                    return mo(
                      ...
                      mo(
                        ...
                        e.tableColGroupNode,
                        mo("tbody", null, mo(El, { slatMetas: i }))
                      ),
                      mo(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        mo(ha, { unit: h ? "minute" : "day" }, function (e) {
  ...
  var Cl = (function () {
      ...
      return (
        ...
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = rt(e)), this.computeTimeTop(kt(e.valueOf() - t.valueOf()))
          );
        }),
  ...
  var Al = nn({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    Ul = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            mo(
              Za,
              r({}, this.props, { defaultTimeFormat: Al, extraClassNames: e })
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(
            ...
            function (e, t) {
              return (
                t && mo("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            }
          );
        }),
            ...
            i = Ol(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                ...
                return mo(
                  ...
                  "bg-event" === t
                    ? mo(ns, r({ seg: a }, nr(a, n.todayRange, n.nowDate)))
                    : ts(t)
                );
              }
            );
    ...
    ql = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return mo(ha, { unit: a ? "minute" : "day" }, function (l, u) {
            return mo(
              Bl,
  ...
  function eu(e) {
    ...
    return mo(
      So,
      null,
      e.text && mo("a", r({ className: "fc-list-day-text" }, t), e.text),
      e.sideText &&
        mo("a", r({ className: "fc-list-day-side-text" }, t), e.sideText)
    );
  }
              ...
              return mo(
                ...
                (function (e, t, n) {
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    return mo("td", { className: "fc-list-event-time" }, s);
                  }
                  return null;
                })(n, r, t),
                mo(
                ...
                mo("td", { className: "fc-list-event-title", ref: i }, a)
              );
            }
          );
        }),
  ...
  function ru(e) {
    var t = e.event,
      n = t.url;
    return mo("a", r({}, n ? { href: n } : {}), t.title);
  }
  function ou(e) {
    return e.text;
  }
  var iu = (function (e) {
    ...
    return (
        ...
        return mo(
          ...
          function (e, t, n, r) {
            return mo(
              ...
              mo("div", { className: "fc-list-empty-cushion", ref: n }, r)
            );
          }
        );
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return mo(ha, { unit: "day" }, function (e, n) {
          for (var s = [], l = 0; l < a.length; l += 1) {
            var u = a[l];
            if (u) {
              var c = t[l].toISOString();
              s.push(mo(Ql, { key: c, dayDate: t[l], todayRange: n }));
              for (
                var d = 0, p = (u = Kn(u, i.eventOrder));
                d < p.length;
                d++
              ) {
                var f = p[d];
  ...
  function su(e) {
    for (
      var t = rt(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;

    )
      r.push(t), o.push({ start: t, end: Ke(t, 1) }), (t = Ke(t, 1));
  ...
  var du = Ho({ themeClasses: { bootstrap: cu } }),
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = Ke(e.start, -1).toISOString()),
                    (s = Ke(e.end, 1).toISOString()));
                (i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
