!(function (t, e) {
    ...
    class Mi extends B {
        ...
        show(t) {
            this._isShown ||
                ...
                j.trigger(this._element, Li, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
        ...
        hide() {
            ...
            t && (this._isTransitioning = !0),
                ...
                j.off(this._element, Di),
                j.off(this._dialog, Ni),
        ...
        _setEscapeEvent() {
            this._isShown
                ? j.on(this._element, Si, (t) => {
                      this._config.keyboard && t.key === Ti
        ...
        _setResizeEvent() {
            this._isShown
                ? j.on(window, xi, () => this._adjustDialog())
                : j.off(window, xi);
        }
        _hideModal() {
    ...
    const Fi = new Set([
        ...
        Ki = (t, e) => {
            ...
            if (e.includes(i))
                return (
                    !Fi.has(i) ||
                    Boolean(Ui.test(t.nodeValue) || Vi.test(t.nodeValue))
                );
    ...
    class dn extends B {
        ...
        dispose() {
            clearTimeout(this._timeout),
                j.off(this._element.closest(an), ln, this._hideModalHandler),
        ...
        _setListeners() {
            this._config.trigger.split(" ").forEach((t) => {
                ...
                j.on(this._element.closest(an), ln, this._hideModalHandler),
                this._config.selector
                    ? (this._config = {
                          ...this._config,
                          trigger: "manual",
    ...
    class Ln extends B {
        ...
        show() {
            ...
            if (i) {
                const e = "UL" === i.nodeName || "OL" === i.nodeName ? kn : Cn;
        ...
        _activate(t, e, i) {
            ...
            n && s
                ? (n.classList.remove(On), this._queueCallback(o, t, !0))
                : o();
        }
        _transitionComplete(t, e, i) {
            ...
            t.classList.add(An),
                ...
                u(t),
                t.classList.contains(Tn) && t.classList.add(On);
            let n = t.parentNode;
            if (
